    ...
    return (
        ...
        >
            ...
            {onUseAsReference && (
                <MenuItem
                    icon={<Layers size={14} />}
                    label={t('actions.useAsReference')}
